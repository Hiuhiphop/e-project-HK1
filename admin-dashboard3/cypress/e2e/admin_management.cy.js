describe('Admin Dashboard - Lawyer Management', () => {
    ...
    it('should successfully add a new lawyer', () => {
        ...
        cy.contains('button', 'Add Lawyer').click();
        ...
        cy.get('.ant-select-item-option-content').contains('Criminal').click();
        ...
        cy.contains('Successfully added new lawyer!', { timeout: 15000 }).should('be.visible');
        
        
        cy.get('.ant-table-row').should('contain', 'New Lawyer Name');
    });
});